package com.P21BundledValidationZeroConfigurationByAnnotation.model;
...
import com.P21BundledValidationZeroConfigurationByAnnotation.dao.UsersDao;
...
public class Users extends ActionSupport {//implements Action
    ...
    regexFields = {
    		@RegexFieldValidator(type = ValidatorType.SIMPLE,fieldName = "mobileNo",
    				regexExpression = "[0-9]{10}",trim = true,

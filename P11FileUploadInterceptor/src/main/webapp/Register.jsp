...
<body>
	...
	<input type="file" id="Userimage" name="Userimage" value="Upload" required="required"/><br/><br/>
	...
	<s:file id="Userimage" name="Userimage" label="User Image" value="Upload" required="required"/>
